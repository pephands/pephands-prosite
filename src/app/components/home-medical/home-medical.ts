...
import { CauseCategory, Campaign } from '../../Models/camapaigns';
...
@Component({
  ...
  templateUrl: './home-medical.html',
  styleUrl: './home-medical.css',
})
export class HomeMedical implements OnInit {
  ...
  ngOnInit() {
    this.isLoading = true;
    this.fetchCampaignsByCategory(1);
  }
